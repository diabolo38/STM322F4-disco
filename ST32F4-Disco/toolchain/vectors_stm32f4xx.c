...
pfn g_pfnVectors[] =
  {
  // Core Level - CM4
      (pfn) &_estack,                           // 0 The initial stack pointer
      Reset_Handler,                            // 4 The reset handler

      NMI_Handler,                              // 8 The NMI handler
      HardFault_Handler,                        // C The hard fault handler
      MemManage_Handler,                        // 10 The MPU fault handler
      BusFault_Handler,                         // 14 The bus fault handler
      UsageFault_Handler,                       // 18 The usage fault handler
      0,                                        // 1C Reserved
      0,                                        // 20 Reserved
      0,                                        // 24 Reserved
      0,                                        // 28 Reserved
      SVC_Handler,                              // 2C SVCall handler
      DebugMon_Handler,                         // 30 Debug monitor handler
      0,                                        // 34 Reserved
      PendSV_Handler,                           // 38 The PendSV handler
      SysTick_Handler,                          // 3C The SysTick handler
